...
function wpcw_admin_meta_box_assets( $hook ) {
    ...
    $plugin_url = defined( 'WPCW_PLUGIN_URL' ) ? WPCW_PLUGIN_URL : plugin_dir_url( __DIR__ );
...
<div class="wpcw-tab-content" id="wpcw-tab-stats">
    <div class="contenedor-estadisticas">
        ...
        $redemption_data = $wpdb->get_results(
            $wpdb->prepare(
            ...
            new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        echo json_encode(
                            array_map(
                                function ( $date ) use ( $successful_data ) {
