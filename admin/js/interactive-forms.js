...
(function($) {
    ...
    function bindEvents() {
        ...
        $(document).on('input blur', '.wpcw-validate', function() {
            const $field = $(this);
            ...
            validationTimeout[fieldName] = setTimeout(function() {
                validateField($field);
            }, 500);
        });

        // Immediate validation on change for selects
        $(document).on('change', '.wpcw-validate', function() {
            validateField($(this));
        });

        // Save draft button
        $(document).on('click', '.wpcw-save-draft', function(e) {
            e.preventDefault();
            saveDraft($(this).closest('.wpcw-interactive-form'));
        });

        // Validate all button
        $(document).on('click', '.wpcw-validate-all', function(e) {
            e.preventDefault();
        ...
        // CUIT formatting
        $(document).on('input', '[data-validation*="cuit"]', function() {
            formatCUIT($(this));
        });

        // Phone formatting
        $(document).on('input', '[data-validation*="phone"], [data-validation*="whatsapp"]', function() {
            formatPhone($(this));
        });
    }
    ...
    function setupAutoSave() {
        ...
        $(document).on('input change', '.wpcw-validate', function() {
    ...
    function initializeFormProgress() {
        $('.wpcw-interactive-form').each(function() {
    ...
    function initKeyboardNavigation() {
        $(document).on('keydown', '.wpcw-validate', function(e) {
