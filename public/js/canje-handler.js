...
(function($) {
    ...
    $(document).ready(function() {
        // console.log('canje-handler.js loaded');
        // console.log(wpcw_canje_obj); // Para verificar que el objeto localizado está disponible

        $('body').on('click', '.wpcw-canjear-cupon-btn', function(e) {
            e.preventDefault();
