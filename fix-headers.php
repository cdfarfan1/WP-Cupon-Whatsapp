...
if (defined('WP_DEBUG') && WP_DEBUG) {
    add_action('plugins_loaded', function() { wpcw_log_header_status('plugins_loaded'); }, 1);
    add_action('init', function() { wpcw_log_header_status('init'); }, 1);
    add_action('admin_init', function() { wpcw_log_header_status('admin_init'); }, 1);
    add_action('admin_notices', function() { wpcw_log_header_status('admin_notices'); }, 0);
}